function [ Ig, bw2, bw3, bw4, bw5, bw6, bw7, mask_em, I_mod, overlay3, overlay4, stats] = uaa_watershedWithOptions( I, analyzedStruct )
    ...
    function img1 = getInputOrCalculate(img1Name , analyzedStruct)
        if isfield(analyzedStruct, img1Name)
            ...
            switch img1Name
                ...
                case {'I_mod','L','overlay3'}
                    [img1{1},img1{2},img1{3}] = wDoSpineWatershed(mask_em,bw7);
            end
        end
...
%%
    function Ig = gaussfilt(I)
        Ig=imgaussfilt(I,uaa.settings.watershed.gaussSigma);
    end
%%
...
%%
    function [I_mod,L,overlay3] = wDoSpineWatershed(mask_em,bw7)
